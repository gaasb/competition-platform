...
var UserTokenTableColumns = struct {
	...
	AccessToken:  "user_tokens.access_token",
	RefreshToken: "user_tokens.refresh_token",
	ExpireAt:     "user_tokens.expire_at",
}
...
var UserTokenWhere = struct {
	...
	UserID:       whereHelperint64{field: "\"user_tokens\".\"user_id\""},
	AccessToken:  whereHelpernull_String{field: "\"user_tokens\".\"access_token\""},
	RefreshToken: whereHelpernull_String{field: "\"user_tokens\".\"refresh_token\""},
	ExpireAt:     whereHelpertime_Time{field: "\"user_tokens\".\"expire_at\""},
}
...
type userTokenR struct {
	User *UserAccount `boil:"User" json:"User" toml:"User" yaml:"User"`
}
...
func (r *userTokenR) GetUser() *UserAccount {
	if r == nil {
		return nil
	}
	return r.User
...
var (
	userTokenAllColumns            = []string{"user_id", "access_token", "refresh_token", "expire_at"}
	userTokenColumnsWithoutDefault = []string{"expire_at"}
	userTokenColumnsWithDefault    = []string{"user_id", "access_token", "refresh_token"}
	userTokenPrimaryKeyColumns     = []string{"user_id"}
...
func (q userTokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for user_tokens")
	}
...
func (q userTokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserTokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to UserToken slice")
	}
...
func (q userTokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count user_tokens rows")
	}
...
func (q userTokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if user_tokens exists")
	}
...
func (o *UserToken) User(mods ...qm.QueryMod) userAccountQuery {
...
func (userTokenL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserToken interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.UserUserToken = object
		return nil
	}
...
// Adds o to related.R.UserUserToken.
func (o *UserToken) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserAccount) error {
	var err error
	if insert {
...
func FindUserToken(ctx context.Context, exec boil.ContextExecutor, userID int64, selectCols ...string) (*UserToken, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"user_tokens\" where \"user_id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from user_tokens")
	}
...
func (o *UserToken) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no user_tokens provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into user_tokens")
	}
...
func (o *UserToken) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update user_tokens, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update user_tokens row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for user_tokens")
	}
...
func (q userTokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for user_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for user_tokens")
	}
...
func (o UserTokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in userToken slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all userToken")
	}
	return rowsAff, nil
}
...
func (o *UserToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no user_tokens provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("model: unable to upsert user_tokens, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert user_tokens")
	}
...
func (o *UserToken) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no UserToken provided for delete")
	}
	...
	sql := "DELETE FROM \"user_tokens\" WHERE \"user_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from user_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for user_tokens")
	}
...
func (q userTokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no userTokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from user_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for user_tokens")
	}
...
func (o UserTokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from userToken slice")
	}
...
func (o *UserToken) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindUserToken(ctx, exec, o.UserID)
	if err != nil {
		return err
	}
...
func (o *UserTokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in UserTokenSlice")
	}
...
func UserTokenExists(ctx context.Context, exec boil.ContextExecutor, userID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"user_tokens\" where \"user_id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if user_tokens exists")
	}
...
func (o *UserToken) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserTokenExists(ctx, exec, o.UserID)
}
