...
type Match struct {
	...
	FirstTeam       null.String `json:"first_team" boil:"first_team"`
	SecondTeam      null.String `json:"second_team" boil:"second_team"`
	...
	Winner          null.String `json:"winner" boil:"team_winner"`
}
